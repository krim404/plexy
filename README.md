...
This is a matrix bot providing some functionality for managing movie requests for Plex/Emby/Jellyfin via ombi. It is based on the [nio-template](https://github.com/anoadragon453/nio-template) by anoa.
...
Contains the main logic to run API calls against Ombi/MovieDB and all the stuff inbetween.
